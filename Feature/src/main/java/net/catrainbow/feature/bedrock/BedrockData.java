package net.catrainbow.feature.bedrock;
...
import net.catrainbow.feature.utils.FileManager;
...
public class BedrockData {
    ...
    public static void loadItemEntries() {
        ...
        HashMap<String, HashMap<String, Object>> itemEntries = JSON.parseObject(data, new TypeReference<>() {
        });
